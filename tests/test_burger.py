...
class TestBurger:
    ...
    def test_set_buns_successfully(self, mock, burger):
        ...
        assert burger.bun.get_name() == DataForTests.BLACK_BUN and burger.bun.get_price() == DataForTests.PRICE_BLACK_BUN
